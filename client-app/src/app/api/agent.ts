...
const requests = {
  ...
  post: (url: string, body: {}) =>
    axios.post(url, body).then(sleep(300)).then(responseBody),
  put: (url: string, body: {}) =>
    axios.put(url, body).then(sleep(300)).then(responseBody),
  delete: (url: string) =>
    axios.delete(url).then(sleep(300)).then(responseBody),
...
const Activities = {
  list: (params:URLSearchParams): Promise<IActivityEnvelope> =>
    axios.get("/activities", {params:params}).then(sleep(300)).then(responseBody),
